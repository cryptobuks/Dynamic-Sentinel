...
@pytest.fixture
def invalid_darksilk_address(network = 'mainnet'):
...
def test_valid_darksilk_address():
    ...
    assert is_valid_darksilk_address( main ) == True
    assert is_valid_darksilk_address( main, 'mainnet' ) == True
    assert is_valid_darksilk_address( main, 'testnet' ) == False

    assert is_valid_darksilk_address( test ) == False
    assert is_valid_darksilk_address( test, 'mainnet' ) == False
    assert is_valid_darksilk_address( test, 'testnet' ) == True
...
def test_invalid_darksilk_address():
    ...
    assert is_valid_darksilk_address( main ) == False
    assert is_valid_darksilk_address( main, 'mainnet' ) == False
    assert is_valid_darksilk_address( main, 'testnet' ) == False

    assert is_valid_darksilk_address( test ) == False
    assert is_valid_darksilk_address( test, 'mainnet' ) == False
    assert is_valid_darksilk_address( test, 'testnet' ) == False
